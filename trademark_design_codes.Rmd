...
regression_df <- df_no_codes |>
  ...
  mutate(bin = case_when(
    grepl('1986|1987|1988|1989|1990', year) == TRUE ~ 'bin19861990',
    grepl('1991|1992|1993|1994|1995', year) == TRUE ~ 'bin19911995',
    grepl('1996|1997|1998|1999|2000', year) == TRUE ~ 'bin19962000',
    grepl('2001|2002|2003|2004|2005', year) == TRUE ~ 'bin20012005',
    grepl('2006|2007|2008|2009|2010', year) == TRUE ~ 'bin20062010',
    grepl('2011|2012|2013|2014|2015', year) == TRUE ~ 'bin20112015',
    grepl('2016|2017|2018|2019|2020', year) == TRUE ~ 'bin20162020',
    .default = 'bin2021'
                           )) |>
  ...
  group_by(serial_no) |>
  mutate(across(c('n', 'registered', 'published', all_of(intl_classes), 'bin', all_of(years), 'attorney'), max)) |>
  filter(!duplicated(serial_no)) |>
  ungroup()
...
mod1 <- glm(published ~ . - serial_no, family = binomial, data = regression_df_1)
...
mutate(bin = case_when(
    grepl('1986', year) == TRUE ~ 'bin1986',
    grepl('1987|1988|1989|1990|1991', year) == TRUE ~ 'bin19871991',
    grepl('1992|1993|1994|1995|1996', year) == TRUE ~ 'bin19921996',
    grepl('1997|1998|1999|2000|2001', year) == TRUE ~ 'bin19972001',
    grepl('2002|2003|2004|2005|2006', year) == TRUE ~ 'bin20012005',
    grepl('2007|2008|2009|2010|2011', year) == TRUE ~ 'bin20062010',
    grepl('2012|2013|2014|2015|2016', year) == TRUE ~ 'bin20112015',
    grepl('2017|2018|2019|2020|2021', year) == TRUE ~ 'bin20162020',
    .default = 'bin2021'
                           )) |>
