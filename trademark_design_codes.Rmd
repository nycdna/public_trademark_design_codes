...
alt_regression_df_2 <- df_no_codes |>
  ...
  group_by(serial_no) |>
  summarise_at(c('n', 'total_design_apps', intl_classes, years, 'attorney'), max) |>
  mutate('1986' = 0) |>
  ungroup()
...
setDT(as.data.frame(mod5[['coefficients']][51:88]), keep.rownames = TRUE) |>
  rename('effect' = 'mod5[["coefficients"]][51:88]', 'year' = 'rn') |>
